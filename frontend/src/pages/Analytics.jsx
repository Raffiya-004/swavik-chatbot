    ...
    <div className="animate-fade-in">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "24px" }}>
          ...
          <div style={{ height: "300px" }}>
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={stats.chart_data}>
                <defs><linearGradient id="cq2" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#2E7D6F" stopOpacity={0.4} /><stop offset="95%" stopColor="#2E7D6F" stopOpacity={0.02} /></linearGradient></defs>
                ...
                <Area type="monotone" dataKey="queries" stroke="#2E7D6F" strokeWidth={3} fillOpacity={1} fill="url(#cq2)" dot={{ fill: '#2E7D6F', r: 4, strokeWidth: 2, stroke: '#FFF8E7' }} activeDot={{ r: 6, fill: '#2E7D6F', stroke: '#FFF8E7', strokeWidth: 2 }} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div style={{ background: COLORS.bgCard, border: `1px solid ${COLORS.border}`, borderRadius: "24px", padding: "28px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            {[{ label: "🔮 LLM", value: "Gemini 2.5 Flash" }, { label: "🔗 Embeddings", value: "MiniLM-L6-v2" }, { label: "💾 Vector Store", value: "FAISS" }].map((item, i) => (
              <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "14px 16px", background: COLORS.bgDark, borderRadius: "14px", border: `1px solid ${COLORS.borderLight}` }}>
                <span style={{ color: COLORS.textSecondary, fontSize: "13px", fontWeight: 600 }}>{item.label}</span>
